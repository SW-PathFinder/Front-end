    ...
    <>
      ...
      <Modal isOpen={open} onClose={() => setOpen(false)} title="룰북">
        <div className="space-y-4 text-sm text-gray-800">
          <section className="rounded-lg bg-gray-100 p-4 shadow-inner">
            <h3 className="mb-2 border-b pb-1 text-center text-base font-bold">
              🎯 게임 개요
            </h3>
            <p className="leading-relaxed">
              금광부와 방해꾼의 정체를 숨긴 채 서로를 방해하며 금을 찾는 심리
              전략 게임입니다.
              <br />
              플레이어는 무작위로 역할이 정해지며,
          ...
          <section className="rounded-lg bg-gray-50 p-4 shadow-inner">
            <h3 className="mb-2 border-b pb-1 text-center text-base font-bold">
              🕹️ 게임 진행
            </h3>
            <p className="leading-relaxed">
              ...
              수행합니다.
              <br />첫 번째 라운드는 <b>무작위</b>로 시작하며, 이후 라운드는{" "}
              <b>이전 결과</b>
              에 따라 시작 플레이어가 바뀝니다.
              <br />
              ...
              .
              <br />
              3라운드가 끝나면 <b>가장 많은 금</b>을 획득한 플레이어가 최종
              승리합니다.
            </p>
          </section>
          ...
          <section className="rounded-lg bg-gray-50 p-4 shadow-inner">
            ...
            <div className="mb-4">
              ...
              <p className="text-sm leading-relaxed text-gray-700">
                출발지에서 목적지까지 길을 잇습니다. 항상 기존 길과 이어져야
                하며, 손패에서 180도 회전이 가능합니다. 출발지에서 연결된 경로만
                유효합니다.
              </p>
            </div>

            <div className="border-t border-gray-300 pt-4">
              <h4 className="mb-1 font-semibold">📦 행동 카드</h4> <br></br>
              <ul className="list-inside list-disc space-y-3 text-sm leading-relaxed text-gray-700">
                <li>
                  <b>망가진 장비</b>
                  <br />
                  다른 플레이어에게 사용하면 해당 플레이어는 굴 카드를 사용할 수
                  없습니다. 같은 종류의 망가진 장비 카드는 중복으로 받을 수
                  없습니다.
                </li>
                <li>
                  <b>장비 수리</b>
                  ...
                  플레이어에게 사용 가능합니다. 반드시 같은 종류만 수리할 수
                  있습니다.
                </li>
                <li>
                  <b>낙석</b>
          ...
          <section className="rounded-lg bg-gray-50 p-4 shadow-inner">
            ...
            <p>
              ...
              공개합니다. 이 중{" "}
              <span className="font-medium text-yellow-600">1장에만 금</span>이
              들어있습니다.
            </p>
          </section>

          <section className="rounded-lg border-l-4 border-yellow-400 bg-yellow-50 p-4">
            <h3 className="mb-2 border-b pb-1 text-center text-base font-bold">
              🏆 승리 조건
            </h3>
            <ul className="ml-2 list-inside list-disc space-y-1">
              <li>
                <b>금광부:</b> 출발지에서 금 목적지까지 길을 이으면 승리합니다.
              </li>
              <li>
